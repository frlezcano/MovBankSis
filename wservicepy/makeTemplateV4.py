...
dataframe = pd.DataFrame({'cod_banco': [7],
                   ...
                   columns=['Banco', 'Cuenta Corriente', 'Fecha Operación', 'Fecha Recaudación', 'Documento Referencia', 'Código Operación', 'Tipo Pago', 'Monto G$', 'Cuenta Corriente', 'Fecha Operación', 'Estado', 'Glosa', 'Tipo Movimiento', 'Codigo Error', 'Número Movimiento'])
